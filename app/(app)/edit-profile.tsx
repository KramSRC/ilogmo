        ...
        >
          ...
          <View className="items-center mb-6">
            ...
            <TouchableOpacity
              ...
              className="mt-2.5 bg-neutral-100 dark:bg-neutral-800 px-3.5 py-1.5 rounded-full border border-neutral-200 dark:border-transparent"
            >
          ...
          <View className="space-y-4 mb-6">
            ...
            <View>
              ...
              <View className="bg-neutral-100 dark:bg-neutral-800 rounded-xl px-3.5 py-3 border border-neutral-200 dark:border-transparent">
