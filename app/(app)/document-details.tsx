      ...
      >
        ...
        {isLoading ? (
          ...
          <>
            ...
            <View className="bg-white dark:bg-neutral-900 rounded-card p-6 shadow-card dark:shadow-none border border-neutral-200 dark:border-transparent mb-5 items-center text-center">
              {/* Large Icon Badge */}
              <View
