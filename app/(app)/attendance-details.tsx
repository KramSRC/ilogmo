    ...
    <SafeAreaView className="flex-1 bg-background-app dark:bg-neutral-950" edges={['top', 'left', 'right']}>
      ...
      <View className="px-5 pt-3 pb-3 flex-row items-center">
        ...
        <View className="flex-1">
          <Text className="text-xl font-bold font-sans text-neutral-900 dark:text-neutral-100">Attendance Details</Text>
        </View>
      </View>
      ...
      {isLoading ? (
        ...
        <View className="flex-1 items-center justify-center px-6">
          <Text className="text-base font-bold font-sans text-neutral-800 dark:text-neutral-200">Record not found</Text>
        ...
        >
          ...
          <View className="bg-white dark:bg-neutral-900 rounded-card p-6 shadow-card dark:shadow-none border border-neutral-200 dark:border-transparent mb-4 items-center">
            ...
            <Text className="text-lg font-bold font-sans text-neutral-900 dark:text-neutral-100 text-center">
            ...
            {/* Big Hours Count */}
            <View className="mt-5 items-center bg-neutral-50 dark:bg-neutral-900 rounded-2xl py-4 px-8 border border-neutral-100 dark:border-neutral-800 w-full">
              <Text className="text-3xl font-bold font-sans text-neutral-900 dark:text-neutral-100">
                {totalFormatted}
              </Text>
          ...
          <View className="bg-white dark:bg-neutral-900 rounded-card p-5 shadow-card dark:shadow-none border border-neutral-200 dark:border-transparent mb-4 space-y-4">
            ...
            <View className="flex-row items-center justify-between py-1">
              <View className="flex-row items-center">
                ...
                <Text className="ml-2.5 text-xs font-sans text-neutral-600 dark:text-neutral-400">Check In</Text>
              </View>
            ...
            <View className="flex-row items-center justify-between py-1">
              <View className="flex-row items-center">
                <Clock size={16} color={colors.neutral[500]} />
                <Text className="ml-2.5 text-xs font-sans text-neutral-600 dark:text-neutral-400">Check Out</Text>
              </View>
              <Text className="text-sm font-bold font-sans text-neutral-900 dark:text-neutral-100">
            ...
            <View className="flex-row items-center justify-between py-1">
              <View className="flex-row items-center">
                ...
                <Text className="ml-2.5 text-xs font-sans text-neutral-600 dark:text-neutral-400">Break Time</Text>
              </View>
              <Text className="text-sm font-bold font-sans text-neutral-900 dark:text-neutral-100">{breakFormatted}</Text>
            </View>
          </View>

          {/* Location & Additional Info */}
          <View className="bg-white dark:bg-neutral-900 rounded-card p-5 shadow-card dark:shadow-none border border-neutral-200 dark:border-transparent space-y-3">
            <Text className="text-sm font-bold font-sans text-neutral-900 dark:text-neutral-100 border-b border-neutral-100 dark:border-neutral-800 pb-2">
            ...
            <View className="flex-row items-start py-1">
              ...
              <View className="ml-2.5 flex-1">
                <Text className="text-xs font-sans text-neutral-500 dark:text-neutral-400">Location</Text>
                <Text className="text-xs font-semibold font-sans text-neutral-800 dark:text-neutral-200 mt-0.5">
            ...
            <View className="flex-row items-start py-1">
              ...
              <View className="ml-2.5 flex-1">
                <Text className="text-xs font-sans text-neutral-500 dark:text-neutral-400">Notes</Text>
                <Text className="text-xs font-sans text-neutral-700 dark:text-neutral-300 mt-0.5 leading-4">
