    ...
    <View className="space-y-4">
      ...
      <View className="bg-white dark:bg-neutral-900 rounded-card p-5 border border-neutral-200 dark:border-neutral-800 shadow-card mb-4">
        ...
        <View className="flex-row justify-between items-center py-2">
          <View className="space-y-3 flex-1 pr-4">
            ...
            <View className="w-28 h-6 bg-neutral-100 rounded-md mb-2" />
            <View className="w-20 h-3 bg-neutral-200 rounded-md" />
            <View className="w-24 h-5 bg-neutral-100 rounded-md" />
          </View>
          <View className="w-24 h-24 rounded-full bg-neutral-100" />
        </View>
      </View>
      ...
      <View className="bg-white dark:bg-neutral-900 rounded-card p-5 border border-neutral-200 dark:border-neutral-800 shadow-card mb-4">
        ...
        <View className="flex-row mb-3">
          <View className="flex-1 h-16 bg-neutral-100 rounded-2xl mr-2" />
          <View className="flex-1 h-16 bg-neutral-100 rounded-2xl ml-2" />
        </View>
