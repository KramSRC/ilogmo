  ...
  return (
    <View className="bg-white rounded-card p-5 shadow-card border border-neutral-200 mb-4">
      ...
      <View className="flex-row mb-3">
        {/* Present */}
        <View className="flex-1 bg-emerald-50/60 rounded-2xl p-3.5 mr-2 border border-emerald-100/80">
          <View className="flex-row items-center mb-1">
            <CheckCircle size={14} color={colors.success.DEFAULT} />
            <Text className="ml-1.5 text-xs font-bold font-sans text-emerald-900">Present</Text>
          </View>
          <Text className="text-lg font-bold font-sans text-emerald-950">
            {overview.presentDays}{' '}
            <Text className="text-xs font-normal text-emerald-700">days</Text>
          </Text>
        </View>

        {/* Late */}
        <View className="flex-1 bg-amber-50/60 rounded-2xl p-3.5 ml-2 border border-amber-100/80">
          <View className="flex-row items-center mb-1">
            <AlertCircle size={14} color={colors.warning.DEFAULT} />
            <Text className="ml-1.5 text-xs font-bold font-sans text-amber-900">Late</Text>
          </View>
      ...
      <View className="flex-row mb-4">
        {/* Absent */}
        <View className="flex-1 bg-red-50/60 rounded-2xl p-3.5 mr-2 border border-red-100/80">
          <View className="flex-row items-center mb-1">
            <XCircle size={14} color={colors.error.DEFAULT} />
            <Text className="ml-1.5 text-xs font-bold font-sans text-red-900">Absent</Text>
          </View>
          <Text className="text-lg font-bold font-sans text-red-950">
            {overview.absentDays} <Text className="text-xs font-normal text-red-700">days</Text>
          </Text>
        </View>
