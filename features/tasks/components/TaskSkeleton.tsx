  ...
  return (
    <View className="space-y-3 mt-1">
      {[1, 2, 3, 4].map((key) => (
        <View
          key={key}
          className="bg-white dark:bg-neutral-900 rounded-card p-4 mb-3 border border-neutral-200 dark:border-transparent shadow-card dark:shadow-none flex-row items-start"
        >
          {/* Checkbox skeleton */}
