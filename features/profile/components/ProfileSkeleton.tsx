  ...
  return (
    <View className="w-full">
      ...
      <View className="items-center mb-6">
        ...
        <View className="w-28 h-3.5 bg-neutral-100 rounded-md" />
      </View>
      ...
      <View className="bg-white dark:bg-neutral-900 rounded-card p-5 mb-4 shadow-card border border-neutral-200 dark:border-neutral-800">
        ...
        <View className="space-y-3">
          <View className="w-full h-10 bg-neutral-100 rounded-lg mb-2" />
          <View className="w-full h-10 bg-neutral-100 rounded-lg mb-2" />
          <View className="w-full h-10 bg-neutral-100 rounded-lg" />
        </View>
      </View>
