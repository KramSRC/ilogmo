  ...
  return (
    ...
    >
      ...
      <View className="flex-row items-center flex-1 mr-2">
        <View className="w-11 h-11 rounded-2xl bg-neutral-50 border border-neutral-200 items-center justify-center mr-3">
          <Text className="text-[10px] font-bold font-sans text-neutral-500 uppercase">
            {dayName}
          </Text>
          <Text className="text-sm font-bold font-sans text-neutral-900 -mt-0.5">{dayNumber}</Text>
        </View>

        {/* Timestamps & Hours */}
        <View className="flex-1">
          <View className="flex-row items-center">
            <Text className="text-xs font-semibold font-sans text-neutral-800">
          ...
          <Text className="text-xs font-sans text-neutral-500 mt-0.5">
            Total: <Text className="font-semibold text-neutral-700">{totalFormatted}</Text>
          </Text>
        </View>
      </View>
