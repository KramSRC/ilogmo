  ...
  return (
    <Modal transparent animationType="fade" visible={visible} onRequestClose={onCancel}>
      <View className="flex-1 bg-black/50 justify-center items-center px-6">
        <View className="bg-white dark:bg-neutral-900 rounded-card p-6 shadow-card dark:shadow-none border border-neutral-200 dark:border-transparent w-full max-w-sm">
          ...
          <View className="bg-neutral-50 dark:bg-neutral-800 rounded-2xl p-4 border border-neutral-100 dark:border-neutral-700 mb-6">
            {isCheckIn ? (
              <View className="items-center py-2">
                ...
                <Text className="text-xs font-sans text-neutral-500 dark:text-neutral-400 mt-2 text-center">
              ...
              <View className="space-y-2">
                ...
                <View className="flex-row justify-between items-center mt-1">
                  <Text className="text-xs font-sans text-neutral-500 dark:text-neutral-400">Checking out at</Text>
                  <Text className="text-xs font-bold font-sans text-neutral-800 dark:text-neutral-200">
                    {nowFormatted}
                  </Text>
                </View>
