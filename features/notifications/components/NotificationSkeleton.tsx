          ...
          <View className="flex-row items-start">
            ...
            <View className="flex-1">
              <View className="flex-row items-center justify-between mb-2">
                ...
                <View className="w-12 h-3 bg-neutral-100 rounded-md" />
              </View>
              <View className="w-full h-3 bg-neutral-100 rounded-md mb-1.5" />
              <View className="w-3/4 h-3 bg-neutral-100 rounded-md" />
            </View>
          </View>
        </View>
      ))}
