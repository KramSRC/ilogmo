    ...
    <View className={`mb-5 ${className}`}>
      {title ? (
        <View className="mb-2 px-1">
          <Text className="text-xs font-bold font-sans text-neutral-400 uppercase tracking-wider">
            {title}
          </Text>
          {subtitle ? (
      ...
      <View className="bg-white rounded-card shadow-card border border-neutral-200 overflow-hidden">
        {children}
      </View>
    </View>
  );
