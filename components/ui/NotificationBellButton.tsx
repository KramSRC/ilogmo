...
export function NotificationBellButton({
  ...
  return (
    <TouchableOpacity
      ...
      className={`rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-soft-sm dark:shadow-none items-center justify-center relative ${
        className || ''
      }`}
    >
