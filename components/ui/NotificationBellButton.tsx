...
export function NotificationBellButton({
  ...
  return (
    <TouchableOpacity
      ...
      className={`rounded-2xl bg-white dark:bg-white/5 border border-neutral-200 dark:border-white/10 shadow-soft-sm dark:shadow-none items-center justify-center relative ${
        className || ''
      }`}
    >
